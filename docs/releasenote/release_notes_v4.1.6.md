...
- **Offline Translation & Plugin Enhancements**: Fixed target language persistence across offline/offlinelite flavors, added translation engine source selector (`Auto / Plugin / Local AI`) in offline flavor, added input script detection, and explicit language pair routing.
...
| **`2-LeanType_4.1.6-offline-release.apk`**      | **Offline AI**   | Local LLM (GGUF) | Browser download + File import | 🚫 Zero Internet (No Permission) | ❌ None               |
