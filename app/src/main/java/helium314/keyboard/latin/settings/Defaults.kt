...
object Defaults {
    ...
    // Adaptive forget window in months: learned touch geometry fades by this half-life so the model
    // tracks recent typing rather than an unbounded all-time average. 0 = never forget.
    const val PREF_ADAPTIVE_FORGET_WINDOW_MONTHS = 3
