...
object SettingsWithoutKey {
    ...
    const val ADAPTIVE_TYPING_STATS = "adaptive_typing_stats"             // entry row (navigates)
    const val ADAPTIVE_TYPING_STATS_CONTENT = "adaptive_typing_stats_content" // the stats body
