...
private val modules = listOf(
    ...
    SettingsModule(SettingsWithoutKey.SCREEN_NAV_TWO_THUMB_TYPING, SettingsDestination.TwoThumbTyping, R.string.settings_screen_two_thumb_typing, iconRes = R.drawable.ic_settings_gesture, provider = ::createTwoThumbTypingSettings),
