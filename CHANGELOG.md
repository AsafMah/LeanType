...
- **Dictionary changes refresh cached spelling and Java fallback gesture suggestions**, including completed personal-dictionary additions; obsolete background index builds cannot overwrite a newer index. (#153)
